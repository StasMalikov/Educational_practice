...
as att_stud on att_stud.AttestationId=Attestations.Id) as result ON result.SubjectId= Subjects.Id order by DateOfEvent DESC limit 5";
    ...
    <div class='container-fluid'>
        ...
        <div class='row'>
            <div class='col-md-9'>
                ...
                <li class="list-inline-item"><a role="button" class="btn btn-info btn-lg" title='Главная' href='student_index.php'>Главная страница</a></li>
                    <li class="list-inline-item"><a role="button" class="btn btn-link btn-lg" title='Главная' href='choose_subj.php'>Просмотр ведомости</a></li>
                </ul>
                <hr>
        ...
        <h4>Последние полученные оценки</h4>
